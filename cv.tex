...
\WorkEntry{Senior Frontend Developer}{2019-present}{CMTech LLC, \url{www.cmtech.by},  Full-time}{
\textbf{Project short summary}: Graphical user interface for trading system.

\textbf{Responsibilities included}: Development of new version of trading application, improvements, troubleshooting, performance optimization, architecture solutions, refactoring, code review.

\textbf{Environment}: Vue.js, Babel, D3, Bootstrap, Sass, Java, Kotlin, Git, WebSockets}
